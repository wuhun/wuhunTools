package tools.com.lvliangliang.wuhuntools.adapter.lazyViewPgaerAdapter;
...
public abstract class LazyPagerAdapter<T> extends PagerAdapter {
     ...
     * to prevent LazyViewPager#onPageScrolled(int, float, int)
     * not working when the offset of LazyViewPager is too big
     */
    @Override
